...
public class GameStageController
{
    ...
    {
	game = new GameLogic();
	game.setProducer(new PTPProducer(game));
	game.setConsumer(new PTPConsumer(game));
	...
	public void setProducer(PTPProducer producer)
	{
	    this.producer = producer;
	}

	public void setConsumer(PTPConsumer consumer)
	{
	    this.consumer = consumer;
	}
	
	public PTPConsumer getConsumer()
	{
	    return consumer;
	}
